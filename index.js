...
let rooms = [
  {
    ...
    bookedDetails: [
      {
        customerName: "Rohith",
        bookedDate: new Date("2023-07-23"),
        startTime: "2023-07-29T08:30",
        endTime: "2023-07-29T11:30",
        status: "confirmed",
        roomID: "100",
      },
    ],
  },
  {
    ...
    bookedDetails: [
      {
        customerName: "Kohli",
        bookedDate: new Date("2023-07-25"),
        startTime: "2023-07-25T15:30",
        endTime: "2023-07-25T17:30",
        status: "confirmed",
        roomID: "101",
      },
    ],
  },
  {
    ...
    bookedDetails: [
      {
        customerName: "Bumrah",
        bookedDate: new Date("2023-06-25"),
        startTime: "2023-06-25T20:30",
        endTime: "2023-06-25T22:30",
